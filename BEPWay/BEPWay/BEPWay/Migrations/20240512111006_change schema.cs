    ...
    public partial class changeschema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RefferalUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Refferences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Refferences_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commissions_Levels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Levels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Commissions_UserPackages_UserPackageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commissions_LevelId",
                table: "Commissions",
                column: "LevelId");

            migrationBuilder.CreateIndex(
                name: "IX_Commissions_UserPackageId",
                table: "Commissions",
                column: "UserPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_Refferences_UserId",
                table: "Refferences",
                column: "UserId");
